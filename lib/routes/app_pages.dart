...
import 'package:ai4bmi/features/catalog/catalog_page.dart';
import 'package:ai4bmi/features/home/home_page.dart';
import 'package:ai4bmi/features/home/product_detail.dart';
import 'package:ai4bmi/features/orders/order_detail_page.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: AppRoutes.catalog, page: () => const CatalogPage()),
    GetPage(
